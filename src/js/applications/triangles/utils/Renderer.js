...
export default class Renderer {
  ...
  setRenderer() {
    ...
    this.instance.setClearColor(0x1f1e1c, 1);
  ...
  setPostprocessing() {
    ...
    // console.log(bloomEffect, ' bloomEffect;');
    // const bloomEffectFolder =
    //   this.application.gui.addFolder('bloomEffectFolder');
    // bloomEffectFolder.add(bloomEffect, 'intensity').min(0).max(10).step(0.001);
    // bloomEffectFolder
    ...
    //   .step(0.001);
    // bloomEffectFolder
    //   .add(bloomEffect.luminanceMaterial, 'smoothing')
    //   .min(0)
    //   .max(10)
    //   .step(0.001);
    ...
    //   kernelSize: 1
    // });
    // blurPass.scale = 0.0001
    // bloomEffectFolder.add(bloomEffect, "radius").min(0).max(10).step(0.001);
